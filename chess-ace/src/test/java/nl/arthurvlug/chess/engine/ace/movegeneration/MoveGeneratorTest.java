...
public class MoveGeneratorTest {
	...
	public void testKingMoves() throws Exception {
		...
		List<Move> whiteMoves = AceMoveGenerator.generateMoves(new ACEBoard(engineBoard, EngineConstants.WHITE));
		...
		List<Move> blackMoves = AceMoveGenerator.generateMoves(new ACEBoard(engineBoard, EngineConstants.BLACK));
